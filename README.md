# Spring Boot Microservices Bookstore
This repository contains the source code for the [Spring Boot Microservices Bookstore](https://www.youtube.com/playlist?list=PLuNxlOYbv61g_ytin-wgkecfWDKVCEDmB).
