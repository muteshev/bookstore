...
import dev.zenfluxpro.bookstore.orders.domain.models.Address;
import dev.zenfluxpro.bookstore.orders.domain.models.Customer;
...
class OrderEntity {
    ...
    private Set<dev.zenfluxpro.bookstore.orders.domain.OrderItemEntity> items;
