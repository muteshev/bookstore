package dev.zenfluxpro.bookstore.orders;
...
public class MockOAuth2UserContextFactory
        implements WithSecurityContextFactory<dev.zenfluxpro.bookstore.orders.WithMockOAuth2User> {

    public SecurityContext createSecurityContext(dev.zenfluxpro.bookstore.orders.WithMockOAuth2User withUser) {
